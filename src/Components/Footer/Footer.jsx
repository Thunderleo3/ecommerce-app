          ...
          <div className="grid grid-cols-4">
            <div>
              ...
              <p className="text-base text-[#272343] font-inter font-normal mb-4 max-w-[350px]">
                Comforty is your go-to destination for premium-quality chairs —
                from ergonomic office seating to elegant lounge pieces. We bring
                comfort to your space, one chair at a time.
              </p>
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-base text-[#9a9caa] font-normal font-inter">
                @ 2025 Designed & Develop{" "}
                <span className="text-[#272343]">Deepak</span>
              </p>
            </div>
